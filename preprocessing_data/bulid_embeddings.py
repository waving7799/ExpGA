...
IMDB_PATH = 'data_set/aclImdb'
MAX_VOCAB_SIZE = 50000
GLOVE_PATH = 'preprocessing_data/glove.840B.300d.txt'
...
glove2 = glove_utils.loadGloveModel('preprocessing_data/counter-fitted-vectors.txt')
